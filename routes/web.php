...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('discount')->group(function () {
            ...
            Route::get('/copan/private', [DiscountController::class, 'copanPrivate'])->name('admin.market.discount.copan.private');
...
//            Route::put('/update/{comment}', [ContentCommentController::class, 'update'])->name('admin.content.comment.update');
    ...
    Route::prefix('user')->namespace('User')->group(function () {
        ...
        Route::prefix('role')->group(function () {
            ...
            Route::get('/permission-update/{role}', [RoleController::class, 'permissionUpdate'])->name('admin.user.role.permission-update');
        });
    ...
    Route::prefix('ticket')->namespace('Ticket')->group(function () {
        ...
        Route::prefix('priority')->group(function () {
            ...
            Route::get('/edit/{ticketCategory}', [TicketPriorityController::class, 'edit'])->name('admin.ticket.priority.edit');
            Route::put('/update/{ticketCategory}', [TicketPriorityController::class, 'update'])->name('admin.ticket.priority.update');
            Route::delete('/destroy/{ticketCategory}', [TicketPriorityController::class, 'destroy'])->name('admin.ticket.priority.destroy');
            Route::get('/status/{ticketCategory}', [TicketPriorityController::class, 'status'])->name('admin.ticket.priority.status');
        });
...
Route::namespace('Market')->group(function () {
    ...
    Route::post('/add-comment/product/{product:slug}', [ProductCustomerController::class, 'addComment'])->name('customer.market.add-comment');
    Route::get('/add-to-favorite/product/{product:slug}', [ProductCustomerController::class, 'addToFavorite'])->name('customer.market.add-to-favorite');
});
...
Route::namespace('profile')->group(function () {
    ...
    Route::get('/my-favorites/delete/{product}', [FavoriteController::class, 'destroy'])->name('customer.profile.my-favorites.delete');
