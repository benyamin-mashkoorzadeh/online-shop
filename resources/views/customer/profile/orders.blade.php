                ...
                <main id="main-body" class="main-body col-md-9">
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="d-flex justify-content-center my-4">
                            ...
                            <a class="btn btn-warning btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=1') }}">در انتظار تأیید</a>
                            <a class="btn btn-success btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=2') }}">تأیید نشده</a>
                            <a class="btn btn-danger btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=3') }}">تأیید شده</a>
