                    ...
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="d-flex justify-content-end my-4">
                            <a class="btn btn-link btn-sm text-info text-decoration-none mx-1" data-bs-toggle="modal"
                               data-bs-target="#edit-profile">
                                <i class="fa fa-edit px-1"></i>ویرایش حساب</a>
                        </section>
                        ...
                        <section class="row">
                            ...
                            <section class="col-6 my-2 py-2">
                                ...
                                <section
                                    class="field-value overflow-auto">{{ auth()->user()->national_code ?? '-'}}</section>
                            </section>
                                            ...
                                            @method('put')
                                                ...
                                                <section class="col-6 mb-2">
                                                    ...
                                                    <input type="text" name="national_code"
                                                           class="form-control form-control-sm"
                                                           id="national_code"
                                                           placeholder="کد ملی" value="{{ auth()->user()->national_code ?? '-' }}">
                                                </section>
