                    ...
                    <section class="d-inline px-md-3">
                        @auth
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                                ...
                                <section><a class="dropdown-item" href="{{ route('customer.profile.orders') }}"><i class="fa fa-newspaper"></i>سفارشات</a>
                                </section>
                                <section><a class="dropdown-item" href="{{ route('customer.profile.my-favorites') }}"><i class="fa fa-heart"></i>لیست
                        ...
                        <section class="header-cart d-inline ps-3 border-start position-relative">
                            ...
                            <section class="header-cart-dropdown">
                                <section class="border-bottom d-flex justify-content-between p-2">
                                    <span
                                        class="text-muted">{{ convertEnglishToPersian($cartItems->count()) }} کالا</span>
                                ...
                                <section class="header-cart-dropdown-body">
                                    ...
                                    @foreach($cartItems as $cartItem)
                                        @php
                                            $totalProductPrice += $cartItem->number * $cartItem->cartItemProductPrice();
                                            $totalDiscount += $cartItem->number * $cartItem->cartItemProductDiscount();
                                        @endphp
