...
@section('content')
                                                ...
                                                <a class="product-link"
                                                   href="{{ route('customer.market.product', $mostVisitedProduct) }}">
                                                    ...
                                                    <section class="product-name">
                                                        <h3>{{ \Illuminate\Support\Str::limit($mostVisitedProduct->name, 10) }}</h3>
                                                    </section>
                                            ...
                                            <section class="product">
                                                ...
                                                <a class="product-link"
                                                   href="{{ route('customer.market.product', $offerProduct) }}">
                                                    ...
                                                    <section class="product-name">
                                                        <h3>
                                                            {{ \Illuminate\Support\Str::limit($offerProduct->name, 10) }}
                                                        </h3>
                                                    </section>
                                                    <section class="product-price-wrapper">
                                                        <section class="product-discount">
    ...
    <section class="position-fixed p-4 flex-row-reverse"
             style="z-index: 9999999999; right: 0; top: 3rem; width: 26rem; max-width: 80%">
