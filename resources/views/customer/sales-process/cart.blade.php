                                        ...
                                        <section class="align-self-start w-100">
                                            ...
                                            <p>
                                                @if(!empty($cartItem->guarantee))
                                                    ...
                                                    <span>گارانتی {{$cartItem->guarantee->name}} </span>
                                                @else
                                            ...
                                            <section>
                                                <section class="cart-product-number d-inline-block ">
                                                    <button class="cart-number-down cart_number" type="button">-
                                                    </button>
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-muted">
                                        <span id="total_product_price">{{ priceFormat($totalProductPrice) }}</span> تومان </p>
                                </section>
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="fw-bolder">
                                        <span id="total_price">{{ priceFormat($totalProductPrice - $totalDiscount) }}</span> تومان</p>
                                </section>
                                            ...
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-price-wrapper">
                                                        <section
                                                            class="product-price">{{ priceFormat($relatedProduct->price) }} تومان</section>
                                                    </section>
