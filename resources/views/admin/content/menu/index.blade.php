...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> منوها</li>
        </ol>
    </nav>
                            ...
                            @foreach($menus as $key => $menu)
                                ...
                                <td>
                                    <input type="checkbox" id="{{ $menu->id }}"
                                           ...
                                           @endif data-url="{{ route('admin.content.menu.status', $menu->id) }}">
                                </td>
                                <td class="max-width-16-rem text-left">
                                    <a href="{{ url('admin.content.menu.edit', $menu->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
                                    <form class="d-inline"
