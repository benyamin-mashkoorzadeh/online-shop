...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> ویرایش اطلاعیه ایمیلی</li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subject" id="subject" class="form-control form-control-sm" value="{{ old('subject', $email->subject) }}">
                                </div>
                            </section>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="published_at_view" id="published_at_view"
                                           class="form-control form-control-sm" value="{{ $email->published_at }}">>
                                </div>
                            </section>
