...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> ویرایش اطلاعیه پیامکی</li>
        </ol>
    </nav>
                ...
                <section>
                    <form action="{{ route('admin.notify.sms.update', $sms->id) }}" method="post">
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="published_at">تاریخ انتشار
                                        @error('published_at')
                                        <span class="alert_required text-danger p-1" role="alert">
                                            <strong>
                                                {{ $message }}
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control form-control-sm">
                                        <option value="0" @if(old('status', $sms->stats) == 0) selected @endif>غیر فعال</option>
                                        <option value="1" @if(old('status', $sms->stats) == 1) selected @endif>فعال</option>
                                    </select>
                                </div>
                            </section>
