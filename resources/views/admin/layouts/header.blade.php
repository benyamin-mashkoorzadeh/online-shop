<header class="header-main">
    <section class="sidebar-header bg-gray">
        <section class="d-flex justify-content-between flex-md-row-reverse px-2">
            ...
            <span id="sidebar-toggle-hide" class="d-md-inline d-none pointer"><i class="fas fa-toggle-on"></i></span>
        ...
        <section class="d-flex justify-content-between">
            <section>
                <span class="mr-5">
                    ...
                    <i id="search-toggle" class="fas fa-search d-none d-md-inline pointer p-1"></i>
                </span>
            ...
            <section>
                ...
                <span class="ml-3 ml-md-5 position-relative">
                    <span id="header-profile-toggle" class="pointer">
                        ...
                        <span class="header-username">بنیامین مشکورزاده</span>
