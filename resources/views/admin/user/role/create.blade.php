...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> ایجاد نقش جدید</li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="description" name="description" class="form-control form-control-sm" value="{{ old('description') }}">
                                </div>
                            </section>
                                ...
                                <section class="row border-top mt-3 py-3">
                                    ...
                                    <section class="col-md-3">
                                        <div class="form-check">
                                            <input type="checkbox" name="permissions[]" id="{{ $permission->id }}" class="form-check-input" value="{{ $permission->id }}" checked>
