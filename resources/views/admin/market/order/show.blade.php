...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> فاکتور سفارش</li>
        </ol>
    </nav>
                    ...
                    <table class="table table-striped table-hover h-150px" id="printable">
                        ...
                        <tr class="table-primary">
                            ...
                            <td class="width-8-rem text-left">
                                <a id="print" href="" class="btn btn-dark btn-sm text-white">
                        ...
                        <tr class="border-bottom">
                            <th>مبلغ نهایی</th>
                            <td class="text-left font-weight-bolder">
                                {{ $order->final_amount - $order->order_discount_amount ?? '-' }}
                            </td>
                        </tr>
