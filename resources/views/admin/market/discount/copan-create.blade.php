...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> ایجاد کوپن تخفیف</li>
        </ol>
    </nav>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type"
                                            ...
                                            class="form-control form-control-sm">
                                        <option @if(old('type') == 0) selected @endif value="0">عمومی</option>
                                        <option @if(old('type') == 1) selected @endif value="1">خصوصی</option>
                                    </select>
                                </div>
                            </section>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="discount_ceiling" id="discount_ceiling"
                                           value="{{ old('discount_ceiling') }}" class="form-control form-control-sm">
                                </div>
                            </section>
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                    ...
                    success: function (response) {
                        if (response.status) {
                            ...
                            response.users.map((user) => {
                                data += `<option <?php echo old('user_id'); ?>  value="${user.id}">${user.first_name + ' ' + user.last_name}</option>`
                            })
