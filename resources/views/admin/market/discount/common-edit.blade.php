...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> ویرایش تخفیف عمومی</li>
        </ol>
    </nav>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="percentage" id="percentage"
                                           class="form-control form-control-sm" value="{{ old('percentage', $commonDiscount->percentage) }}">
                                </div>
                            </section>
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="discount_ceiling" id="discount_ceiling"
                                           class="form-control form-control-sm" value="{{ old('discount_ceiling', $commonDiscount->discount_ceiling) }}">
                                </div>
                            </section>
