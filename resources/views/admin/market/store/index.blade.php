...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> انبار</li>
        </ol>
    </nav>
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td class="width-22-rem text-left">
                                    ...
                                    <a href="{{ route('admin.market.store.edit', $product->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i>
                                        اصلاح موجودی
                                    </a>
                                </td>
                            </tr>
