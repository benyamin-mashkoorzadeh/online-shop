                    ...
                    <section class="row">
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="marketable_number" name="marketable_number" value="{{ old('marketable_number', $product->marketable_number) }}" class="form-control form-control-sm">
                            </div>
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="sold_number" name="sold_number" value="{{ old('sold_number', $product->sold_number) }}" class="form-control form-control-sm">
                            </div>
                            @error('sold_number')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="frozen_number" name="frozen_number" value="{{ old('frozen_number', $product->frozen_number) }}" class="form-control form-control-sm">
                            </div>
                            @error('frozen_number')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
