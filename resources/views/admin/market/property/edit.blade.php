...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active"> ویرایش فرم کالا</li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name', $categoryAttribute->name) }}"
                            ...
                            <section class="col-12 col-md-6">
                                ...
                                <section class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="unit" name="unit" value="{{ old('unit', $categoryAttribute->unit) }}"
                                               class="form-control form-control-sm">
                                    </div>
                                </section>
